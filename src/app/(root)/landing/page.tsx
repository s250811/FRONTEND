export default function Landing() {
    return (
        <main className="flex flex-col justify-center items-center gap-y-[26px] mt-[161px]">
            {/* Title */}
            <span className="text-[40px] font-bold">프로젝트 관리의 모든 것, 픽클AI로 간편하게</span>

            {/* Subtitle */}
            <span className="text-center whitespace-normal break-words w-[660px] mx-auto text-[16px]">
                A smart AI-powered platform that lets anyone manage projects like a pro. Intuitive WBS and Gantt UI with
                automatic predictions enable efficient collaboration and clear project visibility without complexity.
            </span>
