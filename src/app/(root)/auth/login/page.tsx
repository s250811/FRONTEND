    ...
    <main className="min-h-dvh flex items-center justify-center bg-white px-4">
      <section className="w-full max-w-sm">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full h-12 rounded-full bg-black text-white font-semibold tracking-tight"
          >
            로그인
          </button>
        ...
        <div className="mt-4">
          <Link
            href="/auth/signup"
            className="block w-full h-12 rounded-full border border-black text-black font-semibold grid place-items-center hover:bg-black/5"
          >
            회원가입
          </Link>
        </div>
